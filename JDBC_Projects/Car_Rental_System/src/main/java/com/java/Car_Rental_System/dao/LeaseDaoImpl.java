...
public class LeaseDaoImpl implements LeaseDao {
	...
	public Lease searchByLeId(String lid) throws ClassNotFoundException, SQLException {
		...
		while(rs.next()) {
			le = new Lease();
			le.setLease_ID(rs.getString("Lease_ID"));
			le.setVehicle_ID(rs.getString("Vehicle_ID"));
			le.setCustomer_ID(rs.getString("Customer_ID"));
			le.setStart_Date(rs.getDate("Start_Date"));
			le.setEnd_Date(rs.getDate("End_Date"));
	...
	public List<Lease> ShowLast6Month() throws ClassNotFoundException, SQLException {
		...
		while(rs.next()) {
			...
			le.setLease_ID(rs.getString("Lease_ID"));
			le.setVehicle_ID(rs.getString("Vehicle_ID"));
			le.setCustomer_ID(rs.getString("CustomerID"));
			le.setStart_Date(rs.getDate("Star_tDate"));
			le.setEnd_Date(rs.getDate("End_Date"));
			le.setType(rs.getString("Type"));
			LeList.add(le);
		}
